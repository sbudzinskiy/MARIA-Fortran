...
contains
    subroutine test_sanity()
        ...
        rk = schop(1, foo, info, maxr=-1)
        ASSERT(info == -4)

        rk = schop(1, foo, info, rtolf=-ONE)
        ASSERT(info == -5)

        rk = schop(1, foo, info, atolf=-ONE)
        ASSERT(info == -6)

        rk = schop(1, foo, info, rtol2=-ONE)
        ASSERT(info == -7)

        rk = schop(1, foo, info, atol2=-ONE)
        ASSERT(info == -8)
    ...
    subroutine test_quick()
        ...
        rk = schop(0, foo, info, rerrf=rerrf, aerrf=aerrf, rerr2=rerr2, aerr2=aerr2)
        ASSERT(info == 0)
        ASSERT(rk == 0)
        ...
        rk = schop(1, foo, info, rerrf=rerrf, aerrf=aerrf, rerr2=rerr2, aerr2=aerr2)
        ASSERT(info == 0)
        ASSERT(rk == 0)
        ASSERT(safe_eq(rerrf, ZERO))
        ASSERT(safe_eq(aerrf, ZERO))
    ...
    !-- maxr -------------------------------------------------------------------
        maxr = 2
        rk = schop(n, S, info, maxr=maxr, rerrf=rerrf, aerrf=aerrf, rerr2=rerr2, aerr2=aerr2)
        ASSERT(info == 0)
        ASSERT(rk == maxr)
    ...
    !-- atol2 ------------------------------------------------------------------
        atol2 = 2 * ONE
        rk = schop(n, S, info, atol2=atol2, aerr2=aerr2)
        ASSERT(info == 0)
        ASSERT(rk == 3)
    ...
    !-- rtol2 ------------------------------------------------------------------
        rtol2 = 0.1_WP
        rk = schop(n, S, info, rtol2=rtol2, rerr2=rerr2)
        ASSERT(info == 0)
        ASSERT(rk == 1)
    ...
    !-- atolf ------------------------------------------------------------------
        atolf = 11 * ONE
        rk = schop(n, S, info, atolf=atolf, aerrf=aerrf)
        ASSERT(info == 0)
        ASSERT(rk == 2)
    ...
    !-- rtolf ------------------------------------------------------------------
        rtolf = 1e-4_WP
        rk = schop(n, S, info, rtolf=rtolf, rerrf=rerrf)
        ASSERT(info == 0)
        ASSERT(rk == 4)
    ...
    !-- atolf, atol2 -----------------------------------------------------------
        rk = schop(n, S, info, atolf=atolf, atol2=atol2, aerrf=aerrf, aerr2=aerr2)
        ASSERT(info == 0)
        ASSERT(rk == 3)
        ASSERT(safe_leq(aerrf, atolf))
        ASSERT(safe_leq(aerr2, atol2))
    ...
    !-- maxr, rtol2 ------------------------------------------------------------
        rk = schop(n, S, info, maxr=maxr, rtol2=rtol2, rerr2=rerr2)
        ASSERT(info == 0)
        ASSERT(rk == 1)
        ASSERT(safe_leq(rerr2, rtol2))

    end subroutine test
end program schop_test
